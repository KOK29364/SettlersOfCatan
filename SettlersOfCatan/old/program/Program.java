...
public class Program extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		camera.getTransforms().addAll(pivot, yRotate, xRotate, move);
		...
		SubScene subScene = new SubScene(root, 1024, 720, true, SceneAntialiasing.BALANCED);
